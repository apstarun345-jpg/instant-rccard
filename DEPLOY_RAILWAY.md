...
5. Login as Main Admin, open Admin panel → Wallet control, enter a user's mobile, email or exact name in User wallet history, and confirm the summary/table show credits, debits, RC charges, vehicle numbers, time, From/To and IDs.
